...
def standardize_columns(data: pd.DataFrame) -> pd.DataFrame:
    ...
    column_mapping = {
        ...
        '상대.카드번호': 'counterparty_card_number',
        '증빙코드': 'document_type',
        ...
        '변경젼과세유형메시지(코드)': 'previous_vat_message_code',
        '업종코드': 'business_code',
        '주요제품': 'product',
        '기업구분': 'entity_type',
        '회사.업태': 'company_business_type',
        '회사.종목': 'company_business_item',
        '회사.과세유형메시지(코드)': 'company_vat_message_code',
